...
public:
	CSettingDialog(const CString& labelText, int selectedIndex, const std::vector<std::string>& items, CWnd* pParent = nullptr);   // standard constructor
...
private:
	int m_selectedIndex;
	std::vector<std::string> m_comboBoxitems;
public:
